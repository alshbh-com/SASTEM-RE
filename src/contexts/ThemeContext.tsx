...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [platformName, setPlatformNameState] = useState('Reflect');
  const [invoiceName, setInvoiceNameState] = useState('Reflect');
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      if (data) {
        ...
        setPlatformNameState((data as any).platform_name || 'Reflect');
        setInvoiceNameState((data as any).invoice_name || 'Reflect');
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'app_settings' }, (payload) => {
        ...
        if (newData) {
          ...
          setPlatformNameState(newData.platform_name || 'Reflect');
          setInvoiceNameState(newData.invoice_name || 'Reflect');
